...
export async function dashboardRoutes(fastify) {
    ...
    const cacheService = fastify.cache;
    const cacheSubscriber = fastify.cacheSubscriber;
    if (cacheService && cacheSubscriber) {
        dashboardCacheService = new DashboardCacheService(cacheService, cacheSubscriber, monitoring);
    ...
    // Get recent shards
    fastify.get('/dashboard/recent-shards', {
        // Authentication handled by global hook
        schema: {
            tags: ['dashboard'],
    ...
    fastify.get('/dashboards/:id/full', {
        // Authentication handled by global hook
        schema: {
            tags: ['dashboards'],
    ...
    // Set as default
    fastify.post('/dashboards/:id/set-default', {
        // Authentication handled by global hook
        schema: {
            tags: ['dashboards'],
    ...
    fastify.get('/dashboards/:id/widgets', {
        // Authentication handled by global hook
        schema: {
            tags: ['widgets'],
    ...
    // Create widget
    fastify.post('/dashboards/:id/widgets', {
        // Authentication handled by global hook
        schema: {
            tags: ['widgets'],
    ...
    // Update widget
    fastify.patch('/dashboards/:id/widgets/:widgetId', {
        // Authentication handled by global hook
        schema: {
            tags: ['widgets'],
    ...
    // Delete widget
    fastify.delete('/dashboards/:id/widgets/:widgetId', {
        // Authentication handled by global hook
        schema: {
            tags: ['widgets'],
    ...
    // Reorder widgets
    fastify.patch('/dashboards/:id/widgets/reorder', {
        // Authentication handled by global hook
        schema: {
            tags: ['widgets'],
    ...
    fastify.post('/dashboards/:id/widgets/:widgetId/hide', {
        // Authentication handled by global hook
        schema: {
            tags: ['widgets'],
    ...
    fastify.post('/dashboards/:id/widgets/:widgetId/show', {
        // Authentication handled by global hook
        schema: {
            tags: ['widgets'],
    ...
    fastify.get('/dashboards/:id/versions', {
        // Authentication handled by global hook
        schema: {
            tags: ['dashboards'],
    ...
    // Rollback to version
    fastify.post('/dashboards/:id/versions/:version/rollback', {
        // Authentication handled by global hook
        schema: {
            tags: ['dashboards'],
    ...
    fastify.get('/tenant/fiscal-year', {
        // Authentication handled by global hook
        schema: {
            tags: ['configuration'],
    ...
    fastify.patch('/tenant/fiscal-year', {
        // Authentication handled by global hook
        schema: {
            tags: ['configuration'],
