...
export class RiskCatalogService {
  ...
  private async ensureShardType(): Promise<void> {
    try {
      ...
      log.error('Failed to ensure shard type', error, {
  ...
  async getCatalog(tenantId: string, industryId?: string): Promise<RiskCatalog[]> {
    ...
    try {
      ...
      log.error('Failed to get catalog', error, {
  ...
  async createCustomRisk(
    ...
    try {
      ...
      log.error('Failed to create risk', error, {
  ...
  async updateRisk(
    ...
    try {
      ...
      log.error('Failed to update risk', error, {
  ...
  async duplicateRisk(
    ...
    try {
      ...
      log.error('Failed to duplicate risk', error, {
  ...
  async setRiskEnabledForTenant(
    ...
    try {
      ...
      log.error('Failed to set risk enabled for tenant', error, {
  ...
  async deleteRisk(riskId: string, tenantId: string, userId: string): Promise<void> {
    ...
    try {
      ...
      log.error('Failed to delete risk', error, {
  ...
  async getPonderation(
    ...
    try {
      ...
      log.error('Failed to get ponderation', error, {
  ...
  async setPonderation(
    ...
    try {
      ...
      log.error('Failed to set ponderation', error, {
        operation: 'risk-catalog.setPonderation',
        tenantId,
        userId,
        riskId,
        service: 'risk-catalog',
