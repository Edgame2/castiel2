...
export class EmailService {
     ...
     */
    async sendVerificationEmail(to, verificationToken, baseUrl) {
        ...
        `,
            ...
            this.monitoring?.trackException(error, { operation: 'email.service.send-verification', email: to });
     ...
     */
    async sendPasswordResetEmail(to, resetToken, baseUrl) {
        if (!this.isInitialized || !this.resend) {
        ...
        `,
            ...
            this.monitoring?.trackException(error, { operation: 'email.service.send-password-reset', email: to });
    ...
    async sendWelcomeEmail(to, name) {
        ...
        `,
            ...
            this.monitoring?.trackException(error, { operation: 'email.service.send-welcome', email: to });
     ...
     */
    async sendMagicLinkEmail(to, magicLinkUrl, name) {
        if (!this.isInitialized || !this.resend) {
        ...
        `,
            ...
            this.monitoring?.trackException(error, { operation: 'email.service.send-magic-link', email: to });
    ...
    async sendEmail(options) {
        ...
        try {
            ...
            this.monitoring?.trackException(error, { operation: 'email.service.send-generic', email: options.to });
