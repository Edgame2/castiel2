...
class MockOpenAIClient {
    async createEmbedding(texts, model) {
        return {
...
class EmbeddingService {
    ...
    constructor(openaiClient, monitoring, model = 'text-embedding-3-small', dimensions = 1536) {
    ...
    async embedLarge(texts, options = {}) {
...
describe('EmbeddingService', () => {
    ...
    describe('Caching', () => {
        ...
        it('should track cache hits', async () => {
            ...
            // Cache hit
            await service.embed(text);
            expect(mockMonitoring.trackEvent).toHaveBeenCalledWith('embedding-cache-hit', expect.any(Object));
        });
    ...
    describe('Model Configuration', () => {
        it('should use specified model', async () => {
            const customService = new EmbeddingService(mockOpenAI, mockMonitoring, 'text-embedding-3-large', 3072);
