...
export class CollaborationService {
    ...
    logger;
    server;
    constructor(shardRepository, monitoring, logger) {
        ...
        this.server = new Server({
            ...
            async onLoadDocument(data) {
                ...
                try {
                    ...
                    const content = shard.content || shard.structuredData?.content;
                    if (content) {
    ...
    handleConnection(connection, request, documentName, payload) {
