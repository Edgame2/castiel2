...
export function registerRateLimiter(
  ...
  (server as any).rateLimiter = rateLimiter;
}
 ...
 */
export function createUserConnectionRateLimitMiddleware(
  rateLimiter: RateLimiterService | InMemoryRateLimiterService,
  action: 'userConnectionCreate' | 'userConnectionUpdate' | 'userConnectionDelete' | 'userConnectionTest'
) {
  return createRateLimitMiddleware(rateLimiter, {
    action,
    getIdentifier: (request) => {
    ...
    onRateLimited: async (request, reply, result) => {
      ...
      request.log.warn({
        ...
        integrationId: (request.params as { id?: string })?.id,
        ip: request.ip,
        retryAfter,
 ...
 */
export function createUserConnectionTestRateLimitMiddleware(
  rateLimiter: RateLimiterService | InMemoryRateLimiterService
) {
 ...
 */
export function createUserConnectionCreateRateLimitMiddleware(
  rateLimiter: RateLimiterService | InMemoryRateLimiterService
) {
 ...
 */
export function createUserConnectionUpdateRateLimitMiddleware(
  rateLimiter: RateLimiterService | InMemoryRateLimiterService
) {
 ...
 */
export function createUserConnectionDeleteRateLimitMiddleware(
  rateLimiter: RateLimiterService | InMemoryRateLimiterService
) {
 ...
 */
export function createAIInsightsChatRateLimitMiddleware(
  rateLimiter: RateLimiterService | InMemoryRateLimiterService
) {
  return createRateLimitMiddleware(rateLimiter, {
 ...
 */
export function createAIInsightsChatTenantRateLimitMiddleware(
  rateLimiter: RateLimiterService | InMemoryRateLimiterService
) {
  return createRateLimitMiddleware(rateLimiter, {
 ...
 */
export function createAIInsightsGenerateRateLimitMiddleware(
  rateLimiter: RateLimiterService | InMemoryRateLimiterService
) {
  return createRateLimitMiddleware(rateLimiter, {
 ...
 */
export function createAIInsightsGenerateTenantRateLimitMiddleware(
  rateLimiter: RateLimiterService | InMemoryRateLimiterService
) {
  return createRateLimitMiddleware(rateLimiter, {
 ...
 */
export function createAIInsightsQuickRateLimitMiddleware(
  rateLimiter: RateLimiterService | InMemoryRateLimiterService
) {
  return createRateLimitMiddleware(rateLimiter, {
 ...
 */
export function createAIInsightsQuickTenantRateLimitMiddleware(
  rateLimiter: RateLimiterService | InMemoryRateLimiterService
) {
  return createRateLimitMiddleware(rateLimiter, {
 ...
 */
export function createTokenRefreshRateLimitMiddleware(
  rateLimiter: RateLimiterService | InMemoryRateLimiterService
) {
  return createRateLimitMiddleware(rateLimiter, {
    action: 'tokenRefresh',
 ...
 */
export function createLogoutRateLimitMiddleware(
  rateLimiter: RateLimiterService | InMemoryRateLimiterService
) {
  return createRateLimitMiddleware(rateLimiter, {
    action: 'logout',
 ...
 */
export function createTokenRevokeRateLimitMiddleware(
  rateLimiter: RateLimiterService | InMemoryRateLimiterService
) {
  return createRateLimitMiddleware(rateLimiter, {
    action: 'tokenRevoke',
 ...
 */
export function createEmailVerificationRateLimitMiddleware(
  rateLimiter: RateLimiterService | InMemoryRateLimiterService
) {
  return createRateLimitMiddleware(rateLimiter, {
 ...
 */
export function createResendVerificationRateLimitMiddleware(
  rateLimiter: RateLimiterService | InMemoryRateLimiterService
) {
  return createRateLimitMiddleware(rateLimiter, {
