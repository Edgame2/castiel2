/**
 * RiskGauge – risk score 0–1 (Plan §6.3, §890).
 * Displays a radial gauge; color by band: green (&lt;0.33), yellow (0.33–0.66), red (&gt;0.66).
 */
...
export function RiskGauge({ value, label = 'Risk', size = 140 }: RiskGaugeProps) {
