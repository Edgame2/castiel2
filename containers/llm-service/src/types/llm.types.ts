/**
 * LLM Service types (Plan W5 Layer 5 – COMPREHENSIVE_LAYER_REQUIREMENTS_SUMMARY, detailed_layer_requirements)
 */
...
/** W9 – Reactivation strategy (REQUIREMENTS_GAP_ANALYSIS FR-5.4). */
...
/** Request body for POST /api/v1/llm/explain, /recommendations, /scenarios, /summary, /playbook */
...
/** W9 – Request body for POST /api/v1/llm/reactivation/strategy. Optional dormantFeatures and reactivationPrediction from ml-service. */
