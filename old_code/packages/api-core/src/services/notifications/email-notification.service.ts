...
export interface EmailNotificationConfig {
  enabled: boolean;
  sendForTypes?: NotificationType[]; // Only send emails for these types (default: all)
  skipForLowPriority?: boolean; // Skip email for low priority notifications
...
export class EmailNotificationService {
   ...
   */
  private buildEmailSubject(notification: Notification): string {
