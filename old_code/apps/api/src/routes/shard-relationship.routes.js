 ...
 */
export async function shardRelationshipRoutes(server, options) {
 ...
 */
export async function shardRelationshipSubRoutes(server, options) {
    const { monitoring, shardRepository } = options;
    const controller = new ShardRelationshipController(monitoring, shardRepository);
    await controller.initialize();
...
//# sourceMappingURL=shard-relationship.routes.js.map