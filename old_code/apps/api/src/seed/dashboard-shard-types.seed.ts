 ...
 */
export const DASHBOARD_SHARD_TYPE: Omit<ShardType, 'id' | 'createdAt' | 'updatedAt'> = {
  name: 'c_dashboard',
 ...
 */
export const DASHBOARD_WIDGET_SHARD_TYPE: Omit<ShardType, 'id' | 'createdAt' | 'updatedAt'> = {
 ...
 */
export const USER_GROUP_SHARD_TYPE: Omit<ShardType, 'id' | 'createdAt' | 'updatedAt'> = {
  name: 'c_userGroup',
 ...
 */
export const DASHBOARD_VERSION_SHARD_TYPE: Omit<ShardType, 'id' | 'createdAt' | 'updatedAt'> = {
 ...
 */
export function getDashboardShardTypeByName(name: string) {
