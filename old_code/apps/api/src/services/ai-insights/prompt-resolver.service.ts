...
import {
    ...
    PromptScope,
    InsightType
} from '../../types/ai-insights/prompt.types.js';
...
export class PromptResolverService {
    ...
    private readonly TTL_MS = 300 * 1000; // 5 minutes

    constructor(
        private readonly promptRepository: PromptRepository,
        private readonly promptRenderer: PromptRendererService,
        private readonly abTestService?: PromptABTestService,
        private readonly analyticsService?: PromptAnalyticsService,
    ...
    async resolveAndRender(
        ...
        if (this.abTestService && experimentId && variantId) {
            this.abTestService.recordEvent(tenantId, experimentId, userId, {
                ...
                this.monitoring?.trackException(err as Error, { operation: 'prompt-resolver.record-ab-test' });
            });
        }
    ...
    private getFromCache(key: string): Prompt | null {
    ...
    private setCache(key: string, prompt: Prompt): void {
        this.cache.set(key, {
            prompt,
