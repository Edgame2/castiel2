...
export class ShardValidator {
     ...
     */
    validate(structuredData, _shardTypeName) {
        const errors = [];
        const warnings = [];
     ...
     */
    determineValidity(errors, warnings) {
    ...
    isTypeCompatible(expectedType, actualType) {
        ...
        if (expectedType === 'string' && actualType === 'date')
            return true;
        return false;
    }
}
//# sourceMappingURL=ShardValidator.js.map