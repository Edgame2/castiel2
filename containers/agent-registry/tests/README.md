# Agent Registry Module - Test Suite

## Overview

This directory contains the test suite for the agent-registry module, covering unit tests, integration tests, and test fixtures.
