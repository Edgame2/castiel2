  ...
  fastify.put(
    ...
    async (
      ...
      try {
        ...
        const beforeState = await db.organization.findUnique({
          where: { id: orgId },
          select: {
            name: true,
            slug: true,
    ...
    async (
      ...
      try {
        ...
        return {
          data: {
            session: {
              maxSessionsPerUser: org.maxSessionsPerUser,
              sessionTimeoutHours: org.sessionTimeoutHours,
              sessionIdleTimeoutHours: org.sessionIdleTimeoutHours,
            },
            mfa: {
            ...
            password: {
              ...
              requireUppercase: org.passwordRequireUppercase,
              requireLowercase: org.passwordRequireLowercase,
              requireNumbers: org.passwordRequireNumbers,
              requireSpecial: org.passwordRequireSpecial,
              expiryDays: org.passwordExpiryDays,
              historyCount: org.passwordHistoryCount,
            },
          },
        };
      } catch (error: any) {
