...
export class AIAnalyticsService {
    redis;
    monitoring;
    EVENT_PREFIX = 'ai:events:';
    METRICS_PREFIX = 'ai:metrics:';
    DAILY_PREFIX = 'ai:daily:';
     ...
     */
    async recordFeedback(tenantId, eventId, feedback) {
     ...
     */
    async getMetrics(tenantId, period) {
     ...
     */
    async getModelComparison(tenantId) {
        ...
        if (typeof parsed === 'object' && parsed !== null) {
            return Object.entries(parsed).map(([modelId, data]) => ({
                modelId,
...
// Factory
// ============================================
export function createAIAnalyticsService(redis, monitoring) {
