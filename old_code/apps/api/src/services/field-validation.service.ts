...
export interface ValidationContext {
  tenantId: string;
  shardTypeId: string;
  shardId?: string; // For update validation
...
export class FieldValidationService {
  private optionListProvider?: OptionListProvider;
  ...
  async validateRichSchema(
    ...
    for (const fieldDef of schema.fields) {
      ...
      if (fieldDef.system) {continue;}
      if (fieldDef.writeRoles && context.userRoles) {
        const hasWriteAccess = fieldDef.writeRoles.some(role => 
          context.userRoles!.includes(role)
        );
        if (!hasWriteAccess) {continue;}
      }
    ...
    for (const fieldDef of schema.fields) {
      if (fieldDef.validation) {
        const crossFieldErrors = await this.validateCrossFieldRules(
          fieldDef,
          data,
          context
        );
  ...
  private validateTextField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as TextFieldConfig;
  ...
  private validateTextareaField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as TextareaFieldConfig;
  ...
  private validateRichTextField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as RichTextFieldConfig;
  ...
  private async validateSelectField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as SelectFieldConfig;
  ...
  private async validateMultiselectField(
    fieldDef: RichFieldDefinition,
    value: unknown,
    context: ValidationContext
  ): Promise<FieldValidationError[]> {
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as MultiselectFieldConfig;
  ...
  private async getOptions(
    config: SelectFieldConfig | MultiselectFieldConfig,
    tenantId: string
  ...
  private validateDateField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as DateFieldConfig;
  ...
  private validateDateTimeField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as DateTimeFieldConfig;
  ...
  private validateDateRangeField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as DateRangeFieldConfig;
  ...
  private resolveDate(dateConfig: string): Date | null {
    if (dateConfig === 'today') {
      return new Date();
    }
  ...
  private validateIntegerField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as IntegerFieldConfig;
  ...
  private validateFloatField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as FloatFieldConfig;
  ...
  private validateCurrencyField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as CurrencyFieldConfig;
  ...
  private validatePercentageField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as PercentageFieldConfig;
  ...
  private validateBooleanField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as BooleanFieldConfig;
  ...
  private validateEmailField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as EmailFieldConfig;
  ...
  private validateUrlField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as UrlFieldConfig;
  ...
  private validatePhoneField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as PhoneFieldConfig;
  ...
  private validateUserRefField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as UserRefFieldConfig;
  ...
  private validateShardRefField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as ShardRefFieldConfig;
  ...
  private validateFileField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as FileFieldConfig;
  ...
  private validateSingleFile(
    ...
    const f = file as { size?: number; type?: string; name?: string };
  ...
  private validateImageField(
    ...
    const errors: FieldValidationError[] = [];
    const config = fieldDef.config as ImageFieldConfig;
  ...
  private validateSingleImage(
    ...
    if (config.allowedFormats && config.allowedFormats.length > 0) {
      ...
      if (format && !config.allowedFormats.includes(format as any)) {
        errors.push({
          field: fieldDef.name,
  ...
  private async validateCrossFieldRules(
    ...
    if (!fieldDef.validation) {return errors;}
