...
import { IMonitoringProvider } from '../../types/monitoring.js';
...
describe('AdminDashboardService', () => {
    ...
    describe('Provider Health Monitoring', () => {
        ...
        it('should get health for specific provider', async () => {
            ...
            expect((health as any).providerId).toBe(providerId);
        });
        ...
        it('should include latency metrics in health', async () => {
            ...
            expect((firstHealth as any).latency).toBeDefined();
            expect((firstHealth as any).latency.p50).toBeGreaterThanOrEqual(0);
            expect((firstHealth as any).latency.p95).toBeGreaterThanOrEqual(0);
            expect((firstHealth as any).latency.p99).toBeGreaterThanOrEqual(0);
        });
        ...
        it('should include error rate in health', async () => {
            ...
            expect((firstHealth as any).errorRate).toBeDefined();
            expect((firstHealth as any).errorRate).toBeGreaterThanOrEqual(0);
            expect((firstHealth as any).errorRate).toBeLessThanOrEqual(1);
        });
        ...
        it('should include cache hit rate in health', async () => {
            ...
            expect((firstHealth as any).cacheHitRate).toBeDefined();
            expect((firstHealth as any).cacheHitRate).toBeGreaterThanOrEqual(0);
            expect((firstHealth as any).cacheHitRate).toBeLessThanOrEqual(1);
        });
        ...
        it('should return non-existent provider with down status', async () => {
            ...
            expect((health as any).providerId).toBe('non-existent-id');
            expect((health as any).status).toBe('down');
        });
    });
    ...
    describe('Platform Statistics', () => {
        ...
        it('should reflect updates in stats', async () => {
            ...
            await service.updateProvider(
                (await service.getProviders())[0].id,
                { enabled: false }
            );
    ...
    describe('Data Integrity', () => {
        it('should not modify original data on partial updates', async () => {
            const before = await service.getProvider(
                (await service.getProviders())[0].id
            );
