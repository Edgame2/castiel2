 ...
 * MFA Audit Routes
 */
export async function registerMFAAuditRoutes(server) {
    const mfaAuditController = server
        .mfaAuditController;
    if (!mfaAuditController) {
        throw new Error('MFAAuditController not found on server instance');
    }
    // Get MFA audit logs
    server.get('/api/admin/mfa/audit', {
        schema: {
    ...
    // Get MFA statistics
    server.get('/api/admin/mfa/stats', {
        schema: {
    ...
    server.get('/api/admin/mfa/audit/user/:userId', {
        schema: {
    ...
    server.get('/api/admin/mfa/audit/failed-attempts', {
        schema: {
    ...
    // Export audit logs
    server.get('/api/admin/mfa/audit/export', {
        schema: {
...
//# sourceMappingURL=mfa-audit.routes.js.map