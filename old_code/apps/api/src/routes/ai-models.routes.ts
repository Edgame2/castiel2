...
export async function aiModelsRoutes(
  fastify: FastifyInstance,
  options: { monitoring: IMonitoringProvider }
) {
   ...
   */
  fastify.get<{
    Querystring: AIModelListFilters;
  }>(
    '/admin/ai/models',
    {
      schema: {
