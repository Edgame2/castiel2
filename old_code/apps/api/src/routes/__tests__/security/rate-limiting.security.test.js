...
import { InMemoryRateLimiterService } from '../../../services/security/rate-limiter.service.js';
...
describe('Rate Limiting Security Tests', () => {
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle concurrent rate limit checks', async () => {
            ...
            const promises = Array.from({ length: 10 }, () => middleware(mockRequest, mockReply));
...
//# sourceMappingURL=rate-limiting.security.test.js.map