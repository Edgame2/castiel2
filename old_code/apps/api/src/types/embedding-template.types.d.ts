 ...
 */
export declare const DEFAULT_EMBEDDING_TEMPLATE: Omit<EmbeddingTemplate, 'id' | 'createdAt' | 'createdBy' | 'updatedAt'>;
/**
...
//# sourceMappingURL=embedding-template.types.d.ts.map