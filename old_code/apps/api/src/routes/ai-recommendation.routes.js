 ...
 */
export async function registerAIRecommendationRoutes(fastify, aiRecommendationService) {
    /**
     * POST /api/v1/ai-recommendations/generate
     * Generate an AI recommendation
     */
    fastify.post('/ai-recommendations/generate', {
     ...
     */
    fastify.get('/ai-recommendations/types', {
        preHandler: authenticate(null),
        schema: {
            tags: ['AI Recommendations'],
     ...
     */
    fastify.get('/ai-recommendations/rate-limit', {
        preHandler: authenticate(null),
        schema: {
            tags: ['AI Recommendations'],
     ...
     */
    fastify.get('/ai-recommendations/costs', {
        preHandler: authenticate(null),
        schema: {
            tags: ['AI Recommendations'],
        ...
        const entries = aiRecommendationService.getCostTracking(user.tenantId, startDate ? new Date(startDate) : undefined, endDate ? new Date(endDate) : undefined);
...
//# sourceMappingURL=ai-recommendation.routes.js.map