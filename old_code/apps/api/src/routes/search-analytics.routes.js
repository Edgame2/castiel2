...
export async function registerSearchAnalyticsRoutes(server, controller) {
    ...
    // Get query analytics
    server.get('/api/v1/search/analytics/query', {
    ...
    server.get('/api/v1/search/analytics/zero-results', {
        onRequest: authGuards,
        schema: {
    ...
    server.get('/api/v1/search/analytics/satisfaction', {
        onRequest: authGuards,
        schema: {
    ...
    server.get('/api/v1/search/analytics/dashboard', {
        onRequest: authGuards,
        schema: {
    ...
    // Record interaction
    server.post('/api/v1/search/analytics/interaction', {
        onRequest: authGuards,
        schema: {
...
//# sourceMappingURL=search-analytics.routes.js.map