...
const EMAIL_TEMPLATES_CONTAINER: EmailTemplatesContainerConfig = {
  id: 'EmailTemplates',
...
async function createEmailTemplatesContainer(
  database: Database,
  config: EmailTemplatesContainerConfig
...
async function initializeEmailTemplatesContainer(): Promise<void> {
