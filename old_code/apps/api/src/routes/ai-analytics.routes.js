 ...
 */
import { createAIAnalyticsService } from '../services/ai-analytics.service.js';
export async function aiAnalyticsRoutes(fastify, options) {
     ...
     */
    fastify.get('/ai/analytics/metrics', {
        schema: {
     ...
     */
    fastify.get('/ai/analytics/daily', {
        schema: {
     ...
     */
    fastify.get('/ai/analytics/models', {
        schema: {
     ...
     */
    fastify.get('/ai/analytics/insights', {
        schema: {
     ...
     */
    fastify.get('/ai/analytics/prompts/:promptId', {
        schema: {
     ...
     */
    fastify.get('/ai/analytics/prompts/insights', {
        schema: {
     ...
     */
    fastify.get('/ai/analytics/models/:modelId/performance', {
        schema: {
     ...
     */
    fastify.get('/ai/analytics/cache', {
        schema: {
     ...
     */
    fastify.delete('/ai/analytics/cache', {
        schema: {
     ...
     */
    fastify.get('/admin/ai/analytics/metrics', {
        schema: {
     ...
     */
    fastify.get('/admin/ai/analytics/tenants', {
        schema: {
     ...
     */
    fastify.get('/admin/ai/analytics/costs', {
        schema: {
...
//# sourceMappingURL=ai-analytics.routes.js.map