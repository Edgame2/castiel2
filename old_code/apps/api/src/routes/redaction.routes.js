 ...
 */
export async function registerRedactionRoutes(server, monitoring) {
     ...
     */
    server.get('/api/v1/redaction/config', {
     ...
     */
    server.put('/api/v1/redaction/config', {
        ...
        try {
            ...
            await redactionService.configureRedaction(tenantId, fields, redactionValue, userId);
     ...
     */
    server.delete('/api/v1/redaction/config', {
        preHandler: [requireAuth(), requireRole(['tenant-admin', 'super-admin'])],
        schema: {
        ...
        try {
            ...
            await redactionService.configureRedaction(tenantId, [], '[REDACTED]', userId);
...
//# sourceMappingURL=redaction.routes.js.map