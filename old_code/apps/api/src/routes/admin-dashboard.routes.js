 ...
 */
export async function adminDashboardRoutes(fastify, options) {
     ...
     */
    fastify.get('/admin/web-search/providers', {
        schema: {
        ...
        try {
            ...
            options.monitoring.trackException(error, {
     ...
     */
    fastify.get('/admin/web-search/providers/:providerId', {
        schema: {
     ...
     */
    fastify.patch('/admin/web-search/providers/:providerId', {
        schema: {
        ...
        try {
            ...
            const updated = await service.updateProvider(providerId, updates);
            if (!updated) {
                return reply.code(404).send({
                    error: 'Provider not found',
                    providerId,
     ...
     */
    fastify.post('/admin/web-search/providers/:providerId/test', {
        schema: {
     ...
     */
    fastify.get('/admin/web-search/fallback-chain', {
        schema: {
     ...
     */
    fastify.put('/admin/web-search/fallback-chain', {
        schema: {
        ...
        try {
            ...
            const updated = await service.updateFallbackChain('default-chain', updates);
            if (!updated) {
                return reply.code(404).send({
                    error: 'Fallback chain not found',
                });
     ...
     */
    fastify.get('/admin/web-search/health', {
        schema: {
        ...
        try {
            ...
            return reply.code(200).send(Array.isArray(health)
                ? { providers: health }
                : { provider: health });
        }
        catch (error) {
     ...
     */
    fastify.get('/admin/web-search/usage', {
        schema: {
        ...
        try {
            ...
            const usage = await service.getUsageAnalytics(parseInt(days, 10) || 30, tenantId);
     ...
     */
    fastify.get('/admin/quota/:tenantId', {
        schema: {
     ...
     */
    fastify.put('/admin/quota/:tenantId', {
        schema: {
        ...
        try {
            ...
            const updated = await service.updateQuotaConfig(tenantId, updates);
            return reply.code(200).send({
                success: true,
                quota: updated,
            });
     ...
     */
    fastify.get('/admin/tenant-config/:tenantId/web-search', {
        schema: {
     ...
     */
    fastify.put('/admin/tenant-config/:tenantId/web-search', {
        schema: {
        ...
        try {
            ...
            const updated = await service.updateTenantWebSearchConfig(tenantId, updates);
            return reply.code(200).send({
                success: true,
                config: updated,
            });
