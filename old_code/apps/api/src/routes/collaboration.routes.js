...
export async function registerCollaborationRoutes(server, monitoring, shardRepository) {
    const collaborationService = new CollaborationService(shardRepository, monitoring, server.log // FastifyBaseLogger is compatible with pino Logger
    );
