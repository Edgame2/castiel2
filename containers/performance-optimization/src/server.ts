...
export async function buildApp(): Promise<FastifyInstance> {
  ...
  await fastify.register(swagger, {
    openapi: {
      ...
      tags: [
        { name: 'Performance Optimization', description: 'Performance optimization management' },
...
export async function start(): Promise<void> {
  try {
    ...
    console.log(`Performance Optimization listening on http://${config.server.host}:${config.server.port}`);
  } catch (error) {
