...
export async function registerOnboardingRoutes(server, controller) {
    ...
    server.patch('/api/v1/onboarding', {
        onRequest: authGuards,
        schema: {
    ...
    // Skip onboarding
    server.post('/api/v1/onboarding/skip', {
        onRequest: authGuards,
        schema: {
    ...
    server.get('/api/v1/onboarding/stats', {
        onRequest: authGuards,
        schema: {
