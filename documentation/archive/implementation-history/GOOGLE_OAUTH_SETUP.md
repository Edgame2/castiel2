...
- Since the server is running on port **3001**, use `http://localhost:3001/api/auth/google/callback`
- The redirect URI in Google Cloud Console must be exactly: `http://localhost:3001/api/auth/google/callback`
...
- **Solution**: 
  ...
  2. Verify the redirect URI in Google Cloud Console matches exactly: `http://localhost:3001/api/auth/google/callback`
...
- **Server Port**: 3001 (default, can be changed with `PORT` environment variable)
- **OAuth Route**: `/api/auth/google`
- **Callback Route**: `/api/auth/google/callback`
- **Full Callback URL**: `http://localhost:3001/api/auth/google/callback`
