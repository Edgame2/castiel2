...
export interface PredictiveInsight {
    ...
    tenantId: string;
    projectId?: string;
    insightType: 'user_churn' | 'usage_anomaly' | 'growth_forecast' | 'feature_adoption' | 'performance_degradation' | 'custom';
    title: string;
    description: string;
    confidence: number;
...
export interface DashboardMetric {
    ...
    tenantId: string;
    projectId?: string;
    widgetType: 'line_chart' | 'bar_chart' | 'pie_chart' | 'gauge' | 'number' | 'table' | 'heatmap' | 'custom';
    title: string;
    description?: string;
    metricName: string;
