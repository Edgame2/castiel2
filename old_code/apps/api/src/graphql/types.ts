...
// DataLoader interface (will use mercurius built-in loaders)
...
export const validatePaginationArgs = (args: PaginationArgs): { limit: number; offset: number } => {
