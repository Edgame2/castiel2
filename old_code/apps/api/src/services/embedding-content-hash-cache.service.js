...
export class EmbeddingContentHashCacheService {
    ...
    monitoring;
    ttl;
    constructor(redis, monitoring, ttl = DEFAULT_TTL) {
        this.redis = redis;
     ...
     */
    calculateContentHash(text, templateId) {
     ...
     */
    async getCachedBatch(contentHashes) {
     ...
     */
    async setCached(contentHash, embedding, model, dimensions) {
        if (!this.redis) {
...
//# sourceMappingURL=embedding-content-hash-cache.service.js.map