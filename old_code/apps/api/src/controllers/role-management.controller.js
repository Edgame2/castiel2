...
export class RoleManagementController {
    ...
    async getRoleMembers(request, reply) {
        try {
            const { tenantId, roleId } = request.params;
    ...
    async addRoleMembers(request, reply) {
        try {
            const { tenantId, roleId } = request.params;
    ...
    async removeRoleMember(request, reply) {
        try {
    ...
    async createIdPGroupMapping(request, reply) {
        try {
            const { tenantId, roleId } = request.params;
    ...
    async getIdPGroupMappings(request, reply) {
        try {
            const { tenantId, roleId } = request.params;
    ...
    async getPermissions(_request, reply) {
        try {
