...
export class GoogleSlidesRewriter extends BaseDocumentRewriter {
  ...
  async duplicateDocument(
    ...
    try {
      ...
      throw new Error(`Failed to duplicate Google Slides presentation: ${(error as Error).message}`);
    }
  }
  ...
  async replacePlaceholders(
    ...
    return this.executeWithTokenRefresh(async () => {
      ...
      throw new Error(`Failed to replace placeholders in Google Slides: ${(error as Error).message}`);
    });
  }
  ...
  async insertCharts(
    ...
    return this.executeWithTokenRefresh(async () => {
      ...
      throw new Error(`Failed to insert charts in Google Slides: ${(error as Error).message}`);
    });
  }
  ...
  async getDocumentUrl(
    ...
    try {
      ...
      throw new Error(`Failed to get Google Slides document URL: ${(error as Error).message}`);
    }
  }
