 ...
 */
export type ScheduleConfig = ManualScheduleConfig | IntervalScheduleConfig | CronScheduleConfig | RealtimeScheduleConfig;
/**
 * Sync schedule
 */
...
//# sourceMappingURL=sync-task.types.d.ts.map