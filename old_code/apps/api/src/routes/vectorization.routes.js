 ...
 */
import { ChunkingStrategy, EmbeddingModel, } from '../types/vectorization.types.js';
/**
 * Vectorization routes plugin
 */
export const vectorizationRoutes = async (fastify) => {
    const vectorizationService = fastify.vectorizationService;
     ...
     */
    fastify.post('/vectorization/shards/:id', {
        schema: {
            params: {
                type: 'object',
                properties: {
     ...
     */
    fastify.get('/vectorization/jobs/:jobId', {
        schema: {
            params: {
                type: 'object',
                properties: {
     ...
     */
    fastify.get('/vectorization/shards/:id/status', {
        schema: {
            params: {
                type: 'object',
                properties: {
     ...
     */
    fastify.post('/vectorization/batch', {
        schema: {
            body: {
                type: 'object',
                properties: {
...
//# sourceMappingURL=vectorization.routes.js.map