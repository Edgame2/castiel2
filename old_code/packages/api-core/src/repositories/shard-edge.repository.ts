 ...
 */
const createShardEdgeContainerConfig = (containerName: string): ContainerDefinition => ({
  id: containerName,
  partitionKey: {
    paths: ['/tenantId'],
  },
...
export class ShardEdgeRepository {
  ...
  async ensureContainer(): Promise<void> {
    try {
      ...
      await database.containers.createIfNotExists(createShardEdgeContainerConfig(this.containerName));
