...
import { CollaborativeInsightsController } from '../controllers/collaborative-insights.controller.js';
 ...
 */
export async function registerCollaborativeInsightsRoutes(
  server: FastifyInstance,
  controller: CollaborativeInsightsController
): Promise<void> {
  ...
  // Share insight
  server.post(
    '/api/v1/collaborative-insights/share',
    {
  ...
  // Get insight
  server.get(
    '/api/v1/collaborative-insights/:insightId',
    {
      onRequest: authGuards,
  ...
  server.post(
    '/api/v1/collaborative-insights/notifications/:notificationId/read',
    {
      onRequest: authGuards,
