 ...
 */
export function isDocumentFormat(value: any): value is DocumentFormat {
  return (
    typeof value === 'string' &&
 ...
 */
export function isTemplateStatus(value: any): value is TemplateStatus {
  return (
    typeof value === 'string' &&
 ...
 */
export function isPlaceholderType(value: any): value is PlaceholderType {
  return (
    typeof value === 'string' &&
 ...
 */
export function isGenerationJobStatus(value: any): value is GenerationJobStatus {
  return (
    typeof value === 'string' &&
 ...
 */
export function isPlaceholderDefinition(value: any): value is PlaceholderDefinition {
 ...
 */
export function isPlaceholderConfiguration(value: any): value is PlaceholderConfiguration {
  if (!value || typeof value !== 'object') {return false;}
 ...
 */
export function isTemplateVersion(value: any): value is TemplateVersion {
  if (!value || typeof value !== 'object') {return false;}
 ...
 */
export function isDocumentTemplate(value: any): value is DocumentTemplate {
  if (!value || typeof value !== 'object') {return false;}
 ...
 */
export function isGenerationRequest(value: any): value is GenerationRequest {
  if (!value || typeof value !== 'object') {return false;}
 ...
 */
export function isGenerationJob(value: any): value is GenerationJob {
  if (!value || typeof value !== 'object') {return false;}
 ...
 */
export function isGenerationResult(value: any): value is GenerationResult {
  if (!value || typeof value !== 'object') {return false;}
 ...
 */
export function isExtractionRequest(value: any): value is ExtractionRequest {
  if (!value || typeof value !== 'object') {return false;}
 ...
 */
export function isExtractionResult(value: any): value is ExtractionResult {
  if (!value || typeof value !== 'object') {return false;}
 ...
 */
export function isPlaceholderMatch(value: any): value is PlaceholderMatch {
  if (!value || typeof value !== 'object') {return false;}
  
  return (
    typeof value.fullMatch === 'string' &&
    typeof value.placeholderName === 'string' &&
    value.placeholderName.length > 0 &&
 ...
 */
export function validateDocumentTemplate(template: any): {
  valid: boolean;
  errors: string[];
} {
  const errors: string[] = [];
  ...
  if (!isDocumentTemplate(template)) {
    ...
    if (!template.tenantId) {errors.push('Tenant ID is required');}
    if (!template.userId) {errors.push('User ID is required');}
    if (!template.name) {errors.push('Template name is required');}
    if (!template.documentFormat) {errors.push('Document format is required');}
    if (!isDocumentFormat(template.documentFormat)) {
      errors.push(`Invalid document format: ${template.documentFormat}`);
    }
    if (!template.sourceDocumentId) {errors.push('Source document ID is required');}
    if (!Array.isArray(template.placeholders)) {errors.push('Placeholders must be an array');}
...
export function validateGenerationRequest(request: any): {
  ...
  if (!isGenerationRequest(request)) {
    ...
    if (!request.destinationFolderId) {errors.push('Destination folder ID is required');}
