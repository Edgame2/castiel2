 ...
 */
export async function registerProactiveInsightsRoutes(server, proactiveInsightService, deliveryPreferencesRepository, // ProactiveInsightsDeliveryPreferencesRepository
analyticsService) {
     ...
     */
    server.get('/api/v1/proactive-insights', {
     ...
     */
    server.get('/api/v1/proactive-insights/:insightId', {
        onRequest: authGuards,
     ...
     */
    server.post('/api/v1/proactive-insights/:insightId/acknowledge', {
        onRequest: authGuards,
     ...
     */
    server.post('/api/v1/proactive-insights/:insightId/dismiss', {
        onRequest: authGuards,
     ...
     */
    server.post('/api/v1/proactive-insights/:insightId/action', {
        onRequest: authGuards,
    ...
    server.post('/api/v1/proactive-insights/check-triggers', {
        onRequest: authGuards,
 ...
 */
export async function registerDeliveryPreferencesRoutes(server, deliveryPreferencesRepository, // ProactiveInsightsDeliveryPreferencesRepository
analyticsService) {
    const authDecorator = server.authenticate;
     ...
     */
    server.get('/api/v1/proactive-insights/delivery-preferences', {
        onRequest: authGuards,
        schema: {
        ...
        try {
            const { tenantId, userId } = request.user;
            const preferences = await deliveryPreferencesRepository.getPreferences(tenantId, userId);
            if (!preferences) {
                // Return defaults
     ...
     */
    server.put('/api/v1/proactive-insights/delivery-preferences', {
        onRequest: authGuards,
        schema: {
        ...
        try {
            const { tenantId, userId } = request.user;
            const body = request.body || {};
            const preferences = await deliveryPreferencesRepository.upsertPreferences(tenantId, userId, body);
            return reply.status(200).send(preferences);
        }
        catch (error) {
     ...
     */
    server.delete('/api/v1/proactive-insights/delivery-preferences', {
        onRequest: authGuards,
        schema: {
    ...
    if (analyticsService) {
         ...
         */
        server.get('/api/v1/proactive-insights/analytics/metrics', {
            onRequest: authGuards,
            schema: {
         ...
         */
        server.get('/api/v1/proactive-insights/analytics/daily', {
            onRequest: authGuards,
            schema: {
            ...
            try {
                ...
                const dailyMetrics = await analyticsService.getDailyMetrics(tenantId, new Date(startDate), new Date(endDate));
         ...
         */
        server.get('/api/v1/proactive-insights/analytics/triggers', {
            onRequest: authGuards,
            schema: {
         ...
         */
        server.get('/api/v1/proactive-insights/analytics/channels', {
            onRequest: authGuards,
            schema: {
...
//# sourceMappingURL=proactive-insights.routes.js.map