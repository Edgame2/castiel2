export async function registerEmbeddingRoutes(server, monitoring) {
    const shardEmbeddingService = server.shardEmbeddingService;
     ...
     */
    server.post('/shards/:shardId/embeddings/generate', {
        schema: {
        ...
        try {
            ...
            // Generate embeddings
            const result = await shardEmbeddingService.generateEmbeddingsForShard(shard, user.tenantId, { force });
     ...
     */
    server.post('/shard-types/:shardTypeId/embeddings/regenerate', {
        schema: {
        ...
        try {
            ...
            const shards = await shardRepository.findByShardType(shardTypeId, user.tenantId, { limit: 1 });
            ...
            shardEmbeddingService.regenerateEmbeddingsForShardType(shardTypeId, user.tenantId, { force }).then((result) => {
     ...
     */
    server.post('/shards/embeddings/batch', {
        schema: {
        ...
        try {
            ...
            shardEmbeddingService.batchGenerateEmbeddings(shardIds, user.tenantId, { force }).then((result) => {
     ...
     */
    server.get('/tenants/:tenantId/embeddings/stats', {
        schema: {
     ...
     */
    server.get('/shards/:shardId/embeddings/status', {
        schema: {
     ...
     */
    server.get('/shards/:shardId/embeddings/history', {
        schema: {
     ...
     */
    server.post('/shards/:shardId/embeddings/validate', {
        schema: {
     ...
     */
    server.post('/shards/:shardId/embeddings/regenerate', {
        schema: {
     ...
     */
    server.get('/admin/embeddings/cache/stats', {
     ...
     */
    server.delete('/admin/embeddings/cache/clear', {
        preHandler: [server.authenticate],
        schema: {
...
//# sourceMappingURL=embedding.routes.js.map