...
export class GoogleDocsExtractor extends BaseDocumentExtractor {
    ...
    async getDocumentMetadata(documentId, auth) {
        ...
        try {
            ...
            throw new Error(`Failed to get Google Docs metadata: ${error.message}`);
        }
    }
    /**
    ...
    async parseDocument(documentId, auth, request) {
        ...
        try {
            ...
            for (const element of body.content) {
                ...
                if (element.paragraph) {
                    ...
                    if (text.trim()) {
                        ...
                        const elementType = isHeader ? 'header' : 'paragraph';
                        elements.push({
            ...
            throw new Error(`Failed to parse Google Docs document: ${error.message}`);
        }
    }
    /**
     ...
     */
    extractTextFromCellContent(content) {
        let text = '';
     ...
     */
    extractStyleFromParagraph(paragraph) {
...
//# sourceMappingURL=google-docs.extractor.js.map