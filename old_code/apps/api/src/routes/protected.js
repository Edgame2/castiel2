 ...
 */
export async function registerProtectedRoutes(server, tokenValidationCache) {
    /**
     ...
     */
    server.get('/api/profile/notifications', {
        onRequest: [
            authenticate(tokenValidationCache),
            requireAuth(),
        ],
     ...
     */
    server.patch('/api/profile/notifications', {
        onRequest: [
            authenticate(tokenValidationCache),
            requireAuth(),
        ],
     ...
     */
    server.get('/api/profile/activity', {
        onRequest: [
            authenticate(tokenValidationCache),
            requireAuth(),
        ],
        ...
        try {
            ...
            const auditLogController = server.auditLogController;
