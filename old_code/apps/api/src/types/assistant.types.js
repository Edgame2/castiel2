...
// Enums
// ============================================
export var AssistantPersonality;
(function (AssistantPersonality) {
    AssistantPersonality["PROFESSIONAL"] = "professional";
    AssistantPersonality["FRIENDLY"] = "friendly";
    AssistantPersonality["FORMAL"] = "formal";
    AssistantPersonality["CASUAL"] = "casual";
    AssistantPersonality["ANALYTICAL"] = "analytical";
    AssistantPersonality["CREATIVE"] = "creative";
    AssistantPersonality["SUPPORTIVE"] = "supportive";
    AssistantPersonality["DIRECT"] = "direct";
})(AssistantPersonality || (AssistantPersonality = {}));
export var AssistantTone;
(function (AssistantTone) {
    AssistantTone["NEUTRAL"] = "neutral";
    AssistantTone["ENTHUSIASTIC"] = "enthusiastic";
    AssistantTone["EMPATHETIC"] = "empathetic";
    AssistantTone["CONFIDENT"] = "confident";
    AssistantTone["CAUTIOUS"] = "cautious";
    AssistantTone["ENCOURAGING"] = "encouraging";
    AssistantTone["INFORMATIVE"] = "informative";
})(AssistantTone || (AssistantTone = {}));
export var AssistantCapability;
(function (AssistantCapability) {
    AssistantCapability["SUMMARIZATION"] = "summarization";
    AssistantCapability["ANALYSIS"] = "analysis";
    AssistantCapability["RECOMMENDATIONS"] = "recommendations";
    AssistantCapability["WRITING"] = "writing";
    AssistantCapability["RESEARCH"] = "research";
    AssistantCapability["FORECASTING"] = "forecasting";
    AssistantCapability["COACHING"] = "coaching";
    AssistantCapability["Q_AND_A"] = "q_and_a";
    AssistantCapability["DATA_EXTRACTION"] = "data_extraction";
    AssistantCapability["TRANSLATION"] = "translation";
})(AssistantCapability || (AssistantCapability = {}));
export var ResponseFormat;
(function (ResponseFormat) {
    ResponseFormat["CONVERSATIONAL"] = "conversational";
    ResponseFormat["STRUCTURED"] = "structured";
    ResponseFormat["BULLET_POINTS"] = "bullet_points";
...
// Default Assistants
// ============================================
export const DEFAULT_GENERAL_ASSISTANT = {
...
export const DEFAULT_ANALYST_ASSISTANT = {
...
export const DEFAULT_WRITER_ASSISTANT = {
    name: 'Content Writer',
...
export const DEFAULT_RESEARCHER_ASSISTANT = {
...
export const DEFAULT_COACH_ASSISTANT = {
    name: 'Business Coach',
...
//# sourceMappingURL=assistant.types.js.map