...
See [Backend Authentication Module](../modules/backend/auth/) for complete permission list and implementation details.

## Related Documentation

- [Getting Started Guide](./getting-started.md) - Basic user management
- [Admin Guide](./admin-guide.md) - Advanced administration
- [Backend Authentication Module](../modules/backend/auth/) - Technical implementation
