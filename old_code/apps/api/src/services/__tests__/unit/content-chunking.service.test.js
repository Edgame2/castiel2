...
class ContentChunkingService {
    ...
    tokensPerWord = 1.33; // Average token-to-word ratio
    sentenceSplitRegex = /[.!?]+/g;
    ...
    createChunk(text, startIndex, sourceUrl, chunkIndex) {
        return {
            text,
            startIndex,
...
//# sourceMappingURL=content-chunking.service.test.js.map