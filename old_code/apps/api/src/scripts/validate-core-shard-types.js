 ...
 */
import { CORE_SHARD_TYPES, CORE_SHARD_TYPE_NAMES, EMBEDDING_TEMPLATE_MAP, getCoreShardType, } from '../types/core-shard-types.js';
import { RelationshipType, getInverseRelationship } from '../types/shard-edge.types.js';
/**
 * Validate core shard types implementation
 */
export function validateCoreShardTypes() {
    const result = {
        passed: true,
        errors: [],
        warnings: [],
    ...
    result.stats.mappedTemplates = templateKeys.filter(key => EMBEDDING_TEMPLATE_MAP[key] !== undefined).length;
...
//# sourceMappingURL=validate-core-shard-types.js.map