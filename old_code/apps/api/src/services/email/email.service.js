...
import { AzureACSEmailProvider } from './providers/azure-acs.provider.js';
/**
...
export class UnifiedEmailService {
    ...
    fromName;
    monitoring;
    constructor(config, customTemplates, monitoring) {
     ...
     */
    async sendInvitationEmail(to, inviterName, tenantName, inviteToken, baseUrl) {
     ...
     */
    async sendJoinRequestApprovedEmail(to, tenantName, baseUrl) {
     ...
     */
    async sendJoinRequestRejectedEmail(to, tenantName) {
     ...
     * Send MFA code email
     */
    async sendMFACodeEmail(to, code, expiresIn = '10 minutes') {
