        ...
        html: `
          ...
          <html>
            ...
            <body>
              <div class="container">
                <div class="header">
                  <h1>Welcome to Castiel!</h1>
                </div>
                <div class="content">
                  <p>Hi {{firstName}},</p>
                  <p>Welcome to Castiel! We're excited to have you on board.</p>
                  <p>Your account has been successfully created. You can now start using all the features of Castiel.</p>
                  <p style="text-align: center;">
                    <a href="{{appUrl}}" class="button">Get Started</a>
                  </p>
                  <p>If you have any questions, feel free to reach out to our support team.</p>
                  <p>Best regards,<br>The Castiel Team</p>
                </div>
                <div class="footer">
                  <p>This email was sent by Castiel. If you didn't create this account, please ignore this email.</p>
                </div>
              </div>
            </body>
          </html>
...
Welcome to Castiel! We're excited to have you on board.

Your account has been successfully created. You can now start using all the features of Castiel.
...
---
This email was sent by Castiel. If you didn't create this account, please ignore this email.
        `,
      },
      'password-reset': {
        html: `
          ...
          <html>
            ...
            <body>
              <div class="container">
                ...
                <div class="content">
                  <p>Hi,</p>
                  <p>You requested to reset your password for your Castiel account.</p>
                  <p style="text-align: center;">
                ...
                <div class="footer">
                  <p>This email was sent by Castiel. For security reasons, please do not share this link with anyone.</p>
                </div>
              </div>
            </body>
          </html>
...
You requested to reset your password for your Castiel account.
...
---
This email was sent by Castiel. For security reasons, please do not share this link with anyone.
        `,
      },
          ...
          <html>
            ...
            <body>
              <div class="container">
                ...
                <div class="footer">
                  <p>This email was sent by Castiel.</p>
                </div>
              </div>
            </body>
          </html>
...
---
This email was sent by Castiel.
        `,
      },
      'email-verification': {
        html: `
          ...
          <html>
            ...
            <body>
              <div class="container">
                ...
                <div class="footer">
                  <p>This email was sent by Castiel. If you didn't request this verification, please ignore this email.</p>
                </div>
              </div>
            </body>
          </html>
...
---
This email was sent by Castiel. If you didn't request this verification, please ignore this email.
        `,
      },
      'email-verified': {
        html: `
            ...
            <body>
              <div class="container">
                ...
                <div class="content">
                  ...
                  <p>You can now use all features of Castiel.</p>
                  <p>Best regards,<br>The Castiel Team</p>
                </div>
                <div class="footer">
                  <p>This email was sent by Castiel.</p>
...
You can now use all features of Castiel.
          ...
          <html>
            ...
            <body>
              <div class="container">
                ...
                <div class="content">
                  <p>Hi,</p>
                  <p>Your {{provider}} account has been successfully linked to your Castiel account.</p>
...
Your {{provider}} account has been successfully linked to your Castiel account.
          ...
          <html>
            ...
            <body>
              <div class="container">
                ...
                <div class="content">
                  <p>Hi,</p>
                  <p>Your {{provider}} account has been unlinked from your Castiel account.</p>
                  <div class="warning">
                    <p><strong>Security Notice:</strong></p>
...
Your {{provider}} account has been unlinked from your Castiel account.
