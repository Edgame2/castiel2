import { listOwnSessionsSchema, sessionDetailsSchema, terminateSessionSchema, terminateAllSessionsSchema, adminListUserSessionsSchema, adminTerminateSessionSchema, adminTerminateAllSessionsSchema, } from '../schemas/session-management.schemas.js';
import { requireAuth, requireRole, requireSameTenant } from '../middleware/authorization.js';
export async function registerSessionManagementRoutes(server) {
    ...
    server.post('/api/tenants/:tenantId/users/:userId/sessions/:sessionId/terminate', {
    ...
    server.post('/api/tenants/:tenantId/users/:userId/sessions/terminate-all', {
...
//# sourceMappingURL=session-management.routes.js.map