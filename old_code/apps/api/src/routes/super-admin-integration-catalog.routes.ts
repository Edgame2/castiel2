 ...
 */
export async function registerSuperAdminIntegrationCatalogRoutes(
  fastify: FastifyInstance,
  controller: SuperAdminIntegrationCatalogController
): Promise<void> {
   ...
   */
  fastify.get(
    '/super-admin/integration-catalog/:integrationId',
    {
      schema: {
        tags: ['super-admin', 'integration-catalog'],
   ...
   */
  fastify.post(
    '/super-admin/integration-catalog/:integrationId/deprecate',
    {
      schema: {
        tags: ['super-admin', 'integration-catalog'],
   ...
   */
  fastify.get(
    '/super-admin/integration-catalog/:integrationId/shard-mappings',
    {
      schema: {
        tags: ['super-admin', 'integration-catalog'],
   ...
   */
  fastify.get(
    '/super-admin/integration-catalog/:integrationId/visibility',
    {
      schema: {
   ...
   */
  fastify.get(
    '/super-admin/tenants/:tenantId/integration-visibility',
    {
      schema: {
        tags: ['super-admin', 'integration-catalog', 'visibility'],
   ...
   */
  fastify.post(
    '/super-admin/integration-catalog/:integrationId/visibility/:tenantId',
    {
      schema: {
        tags: ['super-admin', 'integration-catalog', 'visibility'],
   ...
   */
  fastify.post(
    '/super-admin/integration-catalog/:integrationId/approve/:tenantId',
    {
      schema: {
        tags: ['super-admin', 'integration-catalog', 'visibility'],
   ...
   */
  fastify.post(
    '/super-admin/integration-catalog/:integrationId/deny/:tenantId',
    {
      schema: {
        tags: ['super-admin', 'integration-catalog', 'visibility'],
   ...
   */
  fastify.post(
    '/super-admin/integration-catalog/:integrationId/hide/:tenantId',
    {
      schema: {
        tags: ['super-admin', 'integration-catalog', 'visibility'],
   ...
   */
  fastify.post(
    '/super-admin/integration-catalog/:integrationId/show/:tenantId',
    {
      schema: {
        tags: ['super-admin', 'integration-catalog', 'visibility'],
   ...
   */
  fastify.post(
    '/super-admin/integration-catalog/:integrationId/whitelist/:tenantId',
    {
      schema: {
   ...
   */
  fastify.post(
    '/super-admin/integration-catalog/:integrationId/block/:tenantId',
    {
      schema: {
   ...
   */
  fastify.post(
    '/super-admin/integration-catalog/:integrationId/make-public',
    {
      schema: {
        tags: ['super-admin', 'integration-catalog', 'whitelist'],
   ...
   */
  fastify.post(
    '/super-admin/integration-catalog/:integrationId/make-private',
    {
      schema: {
        tags: ['super-admin', 'integration-catalog', 'whitelist'],
