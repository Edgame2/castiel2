...
export interface ProjectActivity {
  ...
  details: {
    ...
    sharedWithRole?: string; // 'Manager' | 'Contributor' | 'Viewer'
    bulkShareCount?: number; // For bulk operations

    // SHARD_LINKED / SHARD_UNLINKED / SHARD_RELATIONSHIP_CHANGED
    shardId?: string;
    shardName?: string;
    linkedToShardId?: string;
    linkedToShardName?: string;
    relationshipType?: string; // 'reference_document', 'blocking_task', etc.
    previousRelationshipType?: string;
    bulkLinkCount?: number;

    // AI_CHAT_INITIATED / AI_CHAT_COMPLETED
    ...
    // RECOMMENDATION_GENERATED / RECOMMENDATION_ACCEPTED / RECOMMENDATION_DISMISSED
    ...
    // VERSION_SNAPSHOT_CREATED / VERSION_SNAPSHOT_RESTORED
    snapshotId?: string;
    snapshotLabel?: string;
    snapshotDescription?: string;
    restoredFromVersion?: number;

    // CUSTOM_QUESTION_ADDED / CUSTOM_QUESTION_REMOVED
    questionId?: string;
    questionText?: string;
