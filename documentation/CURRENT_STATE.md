...
| api-gateway | 3001 | `containers/api-gateway/` |
| auth | 3021 | `containers/auth/` |
| cache-management | 3004 | `containers/cache-management/` |
| cache-service | 3035 | `containers/cache-service/` |
| collaboration-intelligence | 3058 | `containers/collaboration-intelligence/` |
| collaboration-service | 3031 | `containers/collaboration-service/` |
| compliance-service | 3043 | `containers/compliance-service/` |
...
| dashboard-analytics | 3056 | `containers/dashboard-analytics/` |
...
| migration-service | 3038 | `containers/migration-service/` |
...
| performance-optimization | 3041 | `containers/performance-optimization/` |
...
### cache-management
- **Description:** Cache administration, optimization, and warming (over cache-service).
- **Features:** Cache admin, optimization, warming; auth and logging.
- **Dependencies:** auth, logging, user-management, cache-service, embeddings.

---

### cache-service
- **Description:** Caching layer (Redis) and cache metrics.
- **Features:** Get/set/delete, TTL, metrics; optional embeddings integration.
- **Dependencies:** logging, embeddings.

---

### collaboration-intelligence
- **Description:** Collaboration analytics and insights (over collaboration-service and AI).
- **Features:** Collaboration insights, analytics over conversations and AI insights.
- **Dependencies:** auth, logging, user-management, collaboration-service, ai-insights.

---

### collaboration-service
- **Description:** Real-time collaboration, conversations, messages.
- **Features:** Conversations, messages, real-time collaboration; notifications.
- **Dependencies:** shard-manager, logging, user-management, notification-manager, ai-insights.

---

### compliance-service
- **Description:** Regulatory and policy compliance (e.g. WCAG, OWASP, GDPR, HIPAA, SOC2).
- **Features:** Compliance checks, requirements, violations, policies, standards.
- **Dependencies:** quality (quality-monitoring), security-service, validation-engine, workflow (workflow-orchestrator), logging.
...
- **Features:** Dashboard CRUD, widgets, analytics and cache integration.
- **Dependencies:** logging, analytics-service, cache-service.

---

### dashboard-analytics
- **Description:** Analytics and aggregations for dashboards.
- **Features:** Dashboard-specific analytics, caching.
- **Dependencies:** auth, logging, user-management, dashboard, analytics-service, cache-service.
...
### migration-service
- **Description:** Code migrations, version upgrades, refactoring automation.
- **Features:** Migration plans, steps, version upgrader, breaking-change handling, refactoring.
- **Dependencies:** context-service, execution, quality (quality-monitoring), knowledge-base, logging.
...
- **Description:** Code and resource performance optimization.
- **Features:** Code, bundle, query, algorithm, memory optimization; profiler.
- **Dependencies:** context-service, observability, execution, quality (quality-monitoring), logging.
...
- **Dependencies:** quality (quality-monitoring), context-service, knowledge-base, compliance-service, logging.
...
| cache-management | auth, logging, user-management, cache-service, embeddings |
| cache-service | logging, embeddings |
| collaboration-intelligence | auth, logging, user-management, collaboration-service, ai-insights |
| collaboration-service | shard-manager, logging, user-management, notification-manager, ai-insights |
| compliance-service | quality-monitoring, security-service, validation-engine, workflow-orchestrator, logging |
...
| dashboard-analytics | auth, logging, user-management, dashboard, analytics-service, cache-service |
...
| validation-engine | quality-monitoring, context-service, knowledge-base, compliance-service, logging |
