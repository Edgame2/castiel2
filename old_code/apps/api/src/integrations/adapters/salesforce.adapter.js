...
export class SalesforceAdapter extends BaseIntegrationAdapter {
    ...
    async getUserProfile() {
        ...
        try {
            const result = await this.makeRequest(`${this.instanceUrl}/services/oauth2/userinfo`);
     ...
     */
    getTitleForEntity(entity, record) {
        const titleFields = {
            Account: 'Name',
            Contact: 'Name',
            Lead: 'Name',
     ...
     */
    getDescriptionForEntity(entity, record) {
        const descFields = {
     ...
     */
    calculateRelevanceScore(query, record, entity) {
     ...
     */
    extractHighlights(query, record, entity) {
        const queryLower = query.toLowerCase();
        const highlights = [];
 ...
 */
export const SALESFORCE_DEFINITION = {
    id: 'salesforce',
    name: 'salesforce',
 ...
 */
export const salesforceAdapterFactory = {
...
//# sourceMappingURL=salesforce.adapter.js.map