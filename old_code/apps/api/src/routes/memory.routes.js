...
export async function registerMemoryRoutes(server, controller) {
    ...
    server.post('/api/v1/memory/remember', {
    ...
    // Forget information
    server.post('/api/v1/memory/forget', {
        onRequest: authGuards,
        schema: {
    ...
    // List all facts
    server.get('/api/v1/memory/facts', {
        onRequest: authGuards,
        schema: {
    ...
    server.delete('/api/v1/memory/facts/:factId', {
        onRequest: authGuards,
        schema: {
