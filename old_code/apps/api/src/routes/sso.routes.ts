...
export async function registerSSORoutes(server: FastifyInstance): Promise<void> {
  const ssoController = (server as FastifyInstance & { ssoController?: SSOController })
    .ssoController;
