 ...
 */
export function registerAPIPerformanceRoutes(server) {
    const performanceMonitoring = server.apiPerformanceMonitoring;
     ...
     */
    server.get('/api/admin/performance/endpoints/:endpoint', {
        schema: {
     ...
     */
    server.post('/api/admin/performance/reset', {
        schema: {
...
//# sourceMappingURL=api-performance.routes.js.map