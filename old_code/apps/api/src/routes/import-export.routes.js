...
export function registerImportExportRoutes(server, controller) {
    // Export routes
    server.post('/api/v1/exports', { schema: createExportSchema }, (request, reply) => controller.createExport(request, reply));
    server.get('/api/v1/exports/:id', { schema: jobIdSchema }, (request, reply) => controller.getExportJob(request, reply));
    server.get('/api/v1/exports/:id/download', { schema: jobIdSchema }, (request, reply) => controller.downloadExport(request, reply));
    // Import routes
    server.post('/api/v1/imports', { schema: createImportSchema }, (request, reply) => controller.createImport(request, reply));
    server.get('/api/v1/imports/:id', { schema: jobIdSchema }, (request, reply) => controller.getImportJob(request, reply));
    server.post('/api/v1/imports/validate', { schema: validateImportSchema }, (request, reply) => controller.validateImport(request, reply));
}
