...
export function registerShardBulkRoutes(
  ...
  // Bulk status change
  server.post(
    '/api/v1/shards/bulk/status',
    { schema: bulkStatusChangeSchema },
    bulkController.bulkStatusChange
  );

  // Bulk tag operations
  server.post(
    '/api/v1/shards/bulk/tags',
    { schema: bulkTagOperationSchema },
    bulkController.bulkTagOperation
  );

  // Bulk export
  server.post(
    '/api/v1/shards/bulk/export',
    { schema: bulkExportSchema },
    bulkController.bulkExport
  );
}
