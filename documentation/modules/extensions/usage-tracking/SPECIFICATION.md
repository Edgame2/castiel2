...
> **Shared Database**: All Usage Tracking data resides in the shared Cosmos DB NoSQL database. The `usage` container stores all usage tracking-related documents.
